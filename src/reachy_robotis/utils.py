...
from reachy_robotis.camera_worker import CameraWorker
...
def parse_args() -> Tuple[argparse.Namespace, list]:  # type: ignore
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Allow downloading an OPENAI_API_KEY from HuggingFace when none is configured (disabled by default)",
    )
    parser.add_argument(
        "--robot-name",
        type=str,
